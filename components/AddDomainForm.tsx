      ...
      <form onSubmit={handleSubmit} className="p-5 flex-1 flex flex-col h-full">
        <div className="flex flex-col gap-2 mb-4">
          ...
          <div className="relative">
            ...
            <input
              className="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-amber-400 focus:border-amber-400 transition-all bg-white dark:bg-gray-800"
